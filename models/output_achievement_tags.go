...
var OutputAchievementTagWhere = struct {
	...
	TagID:                  whereHelperint{field: "`output_achievement_tags`.`tag_id`"},
...
var (
	outputAchievementTagAllColumns            = []string{"output_achievement_tag_id", "output_achievement_id", "tag_id", "created_by", "created_at", "modified_by", "modified_at"}
	outputAchievementTagColumnsWithoutDefault = []string{"output_achievement_id", "tag_id", "created_by", "created_at", "modified_by", "modified_at"}
...
func (o *OutputAchievementTag) Tag(mods ...qm.QueryMod) tagQuery {
...
func (outputAchievementTagL) LoadTag(ctx context.Context, e boil.ContextExecutor, singular bool, maybeOutputAchievementTag interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(qm.From(`tags`), qm.WhereIn(`tags.tag_id in ?`, args...))
	if mods != nil {
		mods.Apply(query)
	}
...
// SetTag of the outputAchievementTag to the related item.
// Sets o.R.Tag to related.
// Adds o to related.R.OutputAchievementTags.
func (o *OutputAchievementTag) SetTag(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Tag) error {
	var err error
	if insert {
	...
	values := []interface{}{related.TagID, o.OutputAchievementTagID}
