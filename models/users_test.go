...
var (
	userDBTypes = map[string]string{`UserID`: `int`, `Name`: `varchar`, `LoginID`: `varchar`, `Password`: `varchar`, `Role`: `tinyint`, `LastLoginAt`: `timestamp`, `CreatedBy`: `int`, `CreatedAt`: `timestamp`, `ModifiedBy`: `int`, `ModifiedAt`: `timestamp`}
	_           = bytes.MinRead
)
