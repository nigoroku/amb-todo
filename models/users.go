...
var (
	userAllColumns            = []string{"user_id", "name", "login_id", "password", "role", "last_login_at", "created_by", "created_at", "modified_by", "modified_at"}
	userColumnsWithoutDefault = []string{"name", "login_id", "password", "role", "last_login_at", "created_by", "created_at", "modified_by", "modified_at"}
